...
message = tk.Label(window, text="Face Recognition and Detection" ,bg="black"  ,fg="white"  ,width=50  ,height=3,font=("Courier New",30,'bold'))
message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter Your College ID",width=28  ,height=2  ,fg="black"  ,bg="white" ,font=('times', 15, ' bold ') )
lbl.place(x=200, y=200)

txt = tk.Entry(window,width=28  ,bg="white" ,fg="black",font=('times', 15, ' bold '))
txt.place(x=600, y=215)

lbl2 = tk.Label(window, text="Enter Your Name",width=28,fg="black",bg="white",height=2 ,font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear  ,fg="black"  ,bg="white"  ,width=28  ,height=2 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=200)
clearButton2 = tk.Button(window, text="Clear", command=clear2  ,fg="black"  ,bg="white"  ,width=28  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
